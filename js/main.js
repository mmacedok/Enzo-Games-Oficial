...
(() => {
    ...
    const JOGOS = {
        flappy: { scripts: ['js/game-dialog.js?v=2', 'js/flappy-core.js?v=1', 'js/flappy.js?v=3'], global: 'FlappyEnzo' },
        ronda: { scripts: ['js/game-dialog.js?v=2', 'js/ronda-core.js?v=2', 'js/ronda.js?v=5'], global: 'RondaDegustador' },
    };
    const carregando = {};
