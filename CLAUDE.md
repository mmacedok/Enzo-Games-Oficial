...
- Antes de qualquer push do `main`, confira que nada do Baralho vai junto:
  ...
  `test/tcg-regras.test.js`, `tools/tcg-simular.mjs`, `tools/batalha-artifact.mjs`, `docs/PLANO-TCG.md`, `docs/BATALHA-ASSETS.md`, `docs/INSTRUCOES-ASSETS-CLAUDE.md`, `docs/PLANO-BATALHA-COMPLETA.md`, `docs/BATALHA-EFEITOS.md`, `docs/PLANO-MULTIPLAYER.md`, `assets/Batalha/`),
